			...
			<body>
				<div class='wrapper'>
            		...
            		<nav id='sidebar'>
                		...
                		<div class='pl-5 ml-5'>
	                		<img src='http://cbit.ac.in/files/ravi.JPG' class='rounded-circle' alt='photo' width='150px' height='150px'>
	                    </div>
	                    <table class='table'>
				  			<tbody>
						      <tr>
						        <td><h5>Name</h5></td>
						        <td><h6>Dr R Ravinder Reddy</h6></td>
						      </tr>
						        <tr>
						        <td><h5>Specialization</h5></td>
						        <td><h6>Data Mining</h6></td>
						      </tr>
						      <tr>
						        <td><h5>Phone No</h5></td>
						        <td><h6>8413232184</h6></td>
						      </tr>
						      <tr>
						        <td><h5>Email ID</h5></td>
						        <td><h6>ravindra_rkk@yahoo.com</h6></td>
						      </tr>
						      <tr>
						        <td><h5>Date of Joining</h5></td>
						        <td><h6>20/06/2004</h6></td>
						      </tr>
						      <tr>
		                ...
		                <ul class='list-unstyled CTAs'>
		                    <li><a href='../index.php' class='article'>Logout</a></li>
		                </ul>
		            </nav>
				</div>
					...
					<div class='row'>
				  	<div class='col-sm-12'>
				  		<ul class='nav nav-tabs nav-justified'>
						    <li class='nav-item'>
						      <a class='nav-link ' href='Staff.php'>Add Attendance</a>
						    </li>
						    <!--li class='nav-item'>
