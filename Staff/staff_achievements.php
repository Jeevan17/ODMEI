	...
	<div class='col-sm-9'>
		<div class='tab-content'>
			<div id='send' class='container tab-pane active'>
				<form action='staff_achievements.php' method='POST' enctype='multipart/form-data'>
					<div class='row'>
						<div class="col-sm-20">
			...
			<div id='delete' class='container tab-pane fade'>
				<div id='get_delete'>
					<table class='table table-bordered table-responsive-sm table-responsive-md table-responsive-lg table-responsive-xl'>
						...
						<tbody>
							<?php
								$sql="SELECT * FROM `staff_achievements` WHERE StaffID='$uname'";
...
<?php
	if(isset($_POST["submit"]))
	{
		...
		try
		{
			...
			$stmt = $dbh->prepare("INSERT INTO `staff_achievements`(`StaffID`, `Title`, `Description`, `DocumentName`, `FileDescription`, `File`) VALUES (?,?,?,?,?,?)");
