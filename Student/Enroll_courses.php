...
<?php
	if(isset($_POST["submit"]))
	{
		...
		{
			$sql = "INSERT INTO student_enroll_courses(RollNumber, YearandSem, CourseID, Timeperiod) VALUES ('$uname', '$yands', '$theory[0]', '$timeperiod')";
			if (mysqli_query($conn, $sql))
			{
			    echo "
			    	<div class='alert alert-dismissible alert-primary'>
			    		<strong>Theory Courses Enrolled Successfully(You can't revert it back)</strong>
					</div>
				";
			}
			else
